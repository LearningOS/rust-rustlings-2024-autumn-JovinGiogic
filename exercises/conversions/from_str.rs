...
impl FromStr for Person {  //不会在解析失败时返回默认值，而是返回一个错误。
    ...
    fn from_str(s: &str) -> Result<Person, Self::Err> {
        ...
        // Step 3: Check if we have exactly two parts (name and age)
        if parts.len() != 2 {
        ...
        // Step 5: Try to parse the second part as a usize for age
